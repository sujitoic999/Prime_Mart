...
import SearchSujit from "./SearchSujit"
import { BsCart2 } from "react-icons/bs";
import MenuSujit from "./MenuSujit";
...
<Flex  color="white" fontWeight={"bold"} border={"2px solid #5ce1e6"} padding="5px" backgroundColor={"#5ce1e6"} justifyContent="space-between">
    ...
    <Box marginTop={"15px"}  borderRadius={"7px"} paddingBottom="-5px" display={{base:"none",sm:"none",md:"inline",lg:"inline"}} ><SearchSujit  /></Box>
    <Box marginTop={"15px"}>
        <Flex   gap={"2rem"}>
            <Box>
                {
                ...
                <Box marginTop="8px" ><MenuSujit  /></Box>
                </Flex></Box>
