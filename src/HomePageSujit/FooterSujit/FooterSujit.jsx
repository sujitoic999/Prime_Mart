  ...
  return (
    <div>
      <Box className="FooterMain">
        ...
        >
          <Box w="33%">
            <Heading size="sm" color={"black"} marginBottom={"7px"}>
              POPULAR CATEGORIES
            </Heading>
            <Text>Staples</Text>
            <Text>Beverages</Text>
          ...
          <Box w="30%">
            ...
            <Text marginBottom={"7px"}>
              ...
              functionality,delayed deliveries,billing errors of other problems
              on the beta website,please email us on cs@primemart.com
            </Text>
            <Heading size="sm" color={"black"} marginBottom={"7px"}>
              DOWNLOAD APP
            </Heading>
      ...
      <Flex fontSize={"small"} color="Gray" backgroundColor={"lightgray"}>
        <Box>
          Best viewed on MIcrosooft Edge 81+,Mozila Firefox 75+,Safari
